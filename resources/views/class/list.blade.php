...
<link rel="stylesheet" type="text/css" href="{{asset('css/manhuaDate.1.0.css')}}">
	<script type="text/javascript" src="{{asset('js/jquery.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('js/manhuaDate.1.0.js')}}"></script>
			...
			<div class="vip">
				<div class="conform">
					<form>
						...
						<div class="cfD">
                            <form>
                        <input class="addUser" type="text" name="f" placeholder="输入用户名/ID/手机号/城市" />
                            <button class="button">搜索</button>
                            </form>
							<a class="addA addA1" href="{{url('/class/add')}}">新增会员+</a> <a
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
                        ...
                        @endforeach
                        <tr>
                            <td colspan="7">{{$res->appends(['f'=>$f])->links()}}</td>
                        </tr>
					</table>
